  ...
  return (
    <View id='faq'>
      ...
      <View id='question-container'>
        ...
        <View className='container'>
          <View className='question'>
            Which other businesses are nearby?
          </View>
          <View className="answer">
        ...
        <View className='container'>
          <View className='question'>
            Can I take a look around your facility?
          </View>
          <View className='answer'>
        ...
        <View className='container'>
          ...
          <View className='answer'>
            We sure do! Our gated and fenced facility is equipped with surveillance cameras which constantly record all activity.
          </View>
        </View>
        <View className='container'>
          <View className='question'>
